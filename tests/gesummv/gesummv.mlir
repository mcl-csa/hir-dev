...
// RUN: verilator --cc build_verilog/*.sv %S/../common/helper.sv --top-module gesummv_hir --Mdir build_verilator %S/main.cpp %S/gesummv.c %S/../common/helper.c --trace --exe  --build
...
attributes {hwAccel,argNames=["alpha","beta","tmp","A","B","X","Y"]} {
  ...
  affine.for %arg7 = 0 to 8 {
    ...
    affine.for %arg8 = 0 to 8 {
      ...
      %16 = arith.addi %15, %12  {result_delays=[0], hir_function=@add_i32} : i32
    ...
    %5 = arith.muli %arg0, %3  {result_delays=[1], hir_function=@mul_i32} : i32
