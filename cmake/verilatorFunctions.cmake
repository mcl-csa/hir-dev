function (add_verilator_project name)
 if(POLICY CMP0144)
  ...
  message (STATUS "Running : verilate(${name} SOURCES ${GENERATED_SV_FILES} ${EXTRA_SV_FILES} TOP_MODULE ${TOP_MODULE} PREFIX V${TOP_MODULE} TRACE VERILATOR_ARGS \"--debug\"")
  verilate(${name} SOURCES ${GENERATED_SV_FILES} ${EXTRA_SV_FILES} TOP_MODULE ${ARG_TOP_MODULE} PREFIX V${ARG_TOP_MODULE} TRACE VERILATOR_ARGS --debug)
endfunction()